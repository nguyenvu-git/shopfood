export default function Banner(){
    const Items = [
        {image:"/public/img/delivery-truck 1.svg",header:"Free Shipping", text:"Free shipping on all your order"},
        {image:"/public/img/delivery-truck 1.svg",header:"Customer Support 24/7", text:"Instant access to Support"},
        {image:"/public/img/delivery-truck 1.svg",header:"100% Secure Payment", text:"We ensure your money is save"},
        {image:"/public/img/delivery-truck 1.svg",header:"Money-Back Guarantee", text:"30 Days Money-Back Guarantee"}
    ]
    return<>
        <div className="sm:w-[1320px] w-full mx-auto ">
