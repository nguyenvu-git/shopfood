      ...
      <div className="sm:w-[1320px] mx-auto pt-[50px] w-[400px]">
        ...
        <div className="flex flex-wrap justify-center items-center py-8 gap-3 sm:gap-0">
            {Products.slice(0, 10).map((product, index) => (
              ...
              <Link to={`product/${product.id}`} className="flex flex-wrap justify-center items-center gap-3 sm:gap-0"  key={product.id}>
                
                <div
                  className="border group cursor-pointer select-none sm:px-[0px] px-3"
                >
                  <img
