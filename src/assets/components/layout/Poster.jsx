  ...
  return (
    <>
      <div className="hidden sm:flex w-[1320px] mx-auto gap-1.5 justify-center items-center mt-[60px]">
        <div className="bg-[url('/img/poster1.jpg')] w-[424px] h-[536px] flex flex-col items-center ">
        ...
        <div className="bg-[url('/img/poster2.jpg')] w-[424px] h-[536px] flex flex-col items-center">
        ...
        <div className="bg-[url('/img/poster3.jpg')] w-[424px] h-[536px] flex flex-col items-center">
